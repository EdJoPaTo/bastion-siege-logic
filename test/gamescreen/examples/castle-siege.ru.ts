...
const examples = [
	{
		...
		text: '⚔️🏰 Твой альянс успешно присоединился к осаде на Рубиновый замок. Вся твоя армия отправлена к его стенам. Всем участникам твоего альянса отправлены уведомления о вступлении в осаду.'
	}, {
		information: {
			castle: 'sapphire',
			type: 'castleSiegeYouJoined'
